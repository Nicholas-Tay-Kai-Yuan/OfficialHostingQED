                ...
                {answers != undefined ?
                    answers.questions.map((questions, index) => (
                        <View style={styles.tableHeaderTotal}>
                            ...
                            <View style={styles.tableContent}>{answers.topic_name == "Fractions" ? formatToFraction(questions.question) : answers.topic_name == "Rational Numbers" ? formatRational(questions.question) : answers.topic_name == "Ordering Numbers" ? formatOrdering(questions.question) : <Text style={styles.tableContentTotal}>{questions.question}</Text>}</View>
                            <View style={styles.tableContent}>{answers.topic_name == "Fractions" ? formatToFraction(questions.answer) : answers.topic_name == "Rational Numbers" ? formatRational(questions.answer) : answers.topic_name == "Ordering Numbers" ? formatOrdering(questions.answer) : <Text style={styles.tableContentTotal}>{questions.answer}</Text>}</View>
                            <View style={styles.tableContent}>{answers.topic_name == "Fractions" ? formatToFraction(questions.correct_answer) : answers.topic_name == "Rational Numbers" ? formatRational(questions.correct_answer) : answers.topic_name == "Ordering Numbers" ? formatOrdering(questions.correct_answer) : <Text style={styles.tableContentTotal}>{questions.correct_answer}</Text>}</View>
